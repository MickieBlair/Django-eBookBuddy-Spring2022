...
let current_width=staff_outer_div_presence.offsetWidth;console.log("current_width",current_width);console.log("last_width_monitoring",last_width_monitoring);console.log("last_width_video",last_width_video);},true);function determine_div_to_display(target){let div_to_display_id=target.id+"_show"
