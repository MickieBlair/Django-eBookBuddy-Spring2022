...
let element=document.getElementById('monitoring_pane');let resizer=document.getElementById('staff_drag');resizer.addEventListener('mousedown',initResize,false);resizer.addEventListener('touchstart',touchinitResize,false);function touchinitResize(e){console.log("INIT Resize",e)
window.addEventListener('touchmove',touchResize,false);window.addEventListener('touchend',touchstopResize,false);}
function touchResize(e){console.log(" Touch Resize",e)
element.style.width=(e.clientX-element.offsetLeft)+'px';element.style.height=(e.clientY-element.offsetTop)+'px';}
function touchstopResize(e){console.log("Touch stopResize",e)
window.removeEventListener('touchmove',touchResize,false);window.removeEventListener('touchend',touchstopResize,false);}
function initResize(e){console.log("INIT Resize",e)
window.addEventListener('mousemove',Resize,false);window.addEventListener('mouseup',stopResize,false);}
function Resize(e){console.log("Resize",e)
element.style.width=(e.clientX-element.offsetLeft)+'px';element.style.height=(e.clientY-element.offsetTop)+'px';}
function stopResize(e){console.log("stopResize",e)
window.removeEventListener('mousemove',Resize,false);window.removeEventListener('mouseup',stopResize,false);}