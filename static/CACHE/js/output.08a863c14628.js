...
let element=document.getElementById('monitoring_pane');let resizer=document.getElementById('staff_drag');resizer.addEventListener('mousedown',initResize,false);resizer.addEventListener('touchstart',initResize,false);function initResize(e){console.log("INIT Resize",e)
