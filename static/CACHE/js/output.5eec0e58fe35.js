...
showTime();};console.log("Loading Session Scripts");const help_request_modal=document.getElementById('helpModal')
const help_request_input=document.getElementById('help_message_content')
help_request_modal.addEventListener('shown.bs.modal',function(){help_request_input.focus()})
