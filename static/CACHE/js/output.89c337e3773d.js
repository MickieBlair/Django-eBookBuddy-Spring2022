...
var container_width=container.width();console.log('container_width',container_width);var sidebar_width=staff_sidebar.width();console.log('sidebar_width',sidebar_width);let width_of_left_now=staff_right_panel_width-lastDownX
console.log('width_of_left_now',width_of_left_now);}).on('mouseup touchend',function(e){isResizing=false;console.log('End isResizing ',isResizing);});};});;