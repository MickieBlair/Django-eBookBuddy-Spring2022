...
let element=document.getElementById('monitoring_pane');let resizer=document.getElementById('staff_drag');resizer.addEventListener('mousedown',initResize,false);function initResize(e){console.log("INIT Resize",e)
window.addEventListener('mousemove',e=>{console.log("Mouse is moving",e)});window.addEventListener('mousemove',Resize,false);window.addEventListener('mouseup',stopResize,false);}
