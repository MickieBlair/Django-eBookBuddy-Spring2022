...
const all_monitoring_divs=document.getElementsByClassName('monitoring_type');const all_side_bar_buttons=document.getElementsByClassName('sidebar_btn');function close_monitoring(element){console.log("close_monitoring",element)
