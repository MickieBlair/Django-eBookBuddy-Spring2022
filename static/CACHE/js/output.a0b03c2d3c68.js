...
let choice_to_check_id=checked_day_times_id.split('_')[3]+'_choice_day_times';let choice_to_check=document.getElementById(choice_to_check_id);if(choice_to_check){choice_to_check.checked=true;}}
