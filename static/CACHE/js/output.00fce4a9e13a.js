...
if(width_of_right_now>=250){if(width_of_left_now>0){staff_sidebar.css('width',"80px");if(str_width_left<=250){console.log("less than 250")}else{console.log("over than 250")}
