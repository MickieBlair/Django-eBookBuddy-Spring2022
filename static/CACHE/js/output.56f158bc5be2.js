...
staff_sidebar.css('width',"75px");staff_left_panel.css('width',str_width_left);staff_right_panel.css('width',str_width_right);}).on('mouseup touchend',function(e){isResizing=false;console.log('End isResizing ',isResizing);});};});;