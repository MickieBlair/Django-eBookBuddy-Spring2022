...
if(width_of_right_now>250){if(width_of_left_now>0){staff_sidebar.css('width',"80px");if(width_of_left_now==250){staff_left_panel.css('width',"250px");isResizing=false;}else{staff_left_panel.css('width',str_width_left);}
staff_right_panel.css('width',str_width_right);}else{isResizing=false;}}else{isResizing=false;}}).on('mouseup touchend',function(e){isResizing=false;console.log('End isResizing ',isResizing);});};});};;