...
let checked_day_times_id=checked_day_times.id;console.log('checked_day_times_id',checked_day_times_id)
let choice_to_check_id=checked_day_times_id.split('_')[2]+'_choice_day_times';console.log('choice_to_check_id',choice_to_check_id)
let choice_to_check=document.getElementById(choice_to_check_id);choice_to_check.click();}}});