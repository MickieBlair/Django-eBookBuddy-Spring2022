...
var window_width=$(window).width();var container_width=container.width();var sidebar_width=staff_sidebar.width();var staff_left_panel_width=staff_left_panel.width();var staff_right_panel_width=staff_right_panel.width();if(container){handle.on('mousedown',function(e){isResizing=true;lastDownX=e.clientX;});$(document).on('mousemove',function(e){if(!isResizing)
