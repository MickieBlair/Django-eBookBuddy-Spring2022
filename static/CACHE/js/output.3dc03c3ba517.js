...
if(!isResizing)
return;if(e.type=='touchmove'){lastDownX=e.changedTouches[0];console.log('touchstart isResizing',isResizing);console.log('touchstart lastDownX',lastDownX);}else if(e.type=='mousemove'){lastDownX=e.clientX;console.log('Mouse down isResizing',isResizing);console.log('mouse down lastDownX',lastDownX);}
