...
let all_sessions_div=document.getElementById('all_sessions_div');all_sessions_div.style.display="none";let matches_in_session_div=document.getElementById('matches_in_session');matches_in_session_div.style.display="block";const outer_session_divs=document.querySelectorAll('.outer_session_div');let id_for_outer_div_show="outer_session_div_"+element.getAttribute("value")
