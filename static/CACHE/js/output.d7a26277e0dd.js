...
let checked_day_times_id=checked_day_times.id;let choice_to_check_id=checked_day_times_id.split('_')[2]+'_choice_day_times';let choice_to_check=document.getElementById(choice_to_check_id);choice_to_check.click();}}});