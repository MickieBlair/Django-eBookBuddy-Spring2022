...
var element=document.getElementById('monitoring_pane');var resizer=document.createElement('staff_drag');resizer.addEventListener('mousedown',initResize,false);function initResize(e){window.addEventListener('mousemove',Resize,false);window.addEventListener('mouseup',stopResize,false);}
