...
var container_width=container.width();console.log('container_width',container_width);var sidebar_width=staff_sidebar.width();console.log('sidebar_width',sidebar_width);let width_of_left=container_width-sidebar_width-lastDownX
console.log('width_of_left',width_of_left);let width_of_right=container_width-width_of_left
console.log('width_of_right',width_of_right);}).on('mouseup touchend',function(e){isResizing=false;console.log('End isResizing ',isResizing);});};});;