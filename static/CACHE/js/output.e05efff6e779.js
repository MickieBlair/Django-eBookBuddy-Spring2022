...
const ws_scheme=window.location.protocol=="https:"?"wss":"ws";console.log(ws_scheme);console.log("Loading Parent Registration Scripts")
...
function email_blur(ev,object){if(ev=="blur"){var email=object.value;check_parent_email(email)}}
