...
showTime();};console.log("Loading Session Scripts");const staff_outer_div_presence=document.getElementById('staff_outer_div')
function close_monitoring(element){console.log("close_monitoring",element)
let monitoring_pane_div=document.getElementById('monitoring_pane');monitoring_pane_div.classList.add('d-none');let staff_drag_bar=document.getElementById('staff_drag');staff_drag_bar.classList.add('d-none');let staff_sidebar_div=document.getElementById('staff_sidebar');let staff_sidebar_div_width=staff_sidebar_div.offsetWidth;console.log("staff_sidebar_div_width",staff_sidebar_div_width);let staff_outer_div_presence_width=staff_outer_div_presence.offsetWidth;console.log("staff_outer_div_presence_width",staff_outer_div_presence_width);let new_width_of_meeting=staff_outer_div_presence_width-staff_sidebar_div_width
