...
var options={roomName:room_name,jwt:token,width:"100%",height:"100%",parentNode:document.querySelector('#meeting'),configOverwrite:{toolbarButtons:buttons,localRecording:{enabled:localRecoding_enabled,},fileRecordingsServiceEnabled:fileRecordingsServiceEnabled,fileRecordingsEnabled:fileRecordingsEnabled,startWithAudioMuted:startAudioMuted,startWithVideoMuted:startVideoMuted,},interfaceConfigOverwrite:{filmStripOnly:true}}
