...
var window_width=$(window).width();console.log('window_width',window_width);var container_width=container.width();console.log('container_width',container_width);var sidebar_width=staff_sidebar.width();console.log('sidebar_width',sidebar_width);var staff_left_panel_width=staff_left_panel.width();console.log('staff_left_panel_width',staff_left_panel_width);var staff_right_panel_width=staff_right_panel.width();console.log('staff_right_panel_width',staff_right_panel_width);if(container){handle.on('mousedown touchstart',function(e){isResizing=true;lastDownX=e.clientX;console.log('e',e);if(e.type=='touchstart'){isResizing=true;lastDownX=e.clientX;console.log('touchstart isResizing',isResizing);console.log('touchstart lastDownX',lastDownX);}else if(e.type=='mousedown'){isResizing=true;lastDownX=e.clientX;console.log('Mouse down isResizing',isResizing);console.log('mouse down lastDownX',lastDownX);}});$(document).on('mousemove touchmove',function(e){console.log("Doing something")
if(!isResizing)
